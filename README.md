...
Sensing Logic (Pre-deployment): Programmed once. Ideally, this is the only component where the user adds sensor-specific functionalities.

Network Configuration (Deployment): Handles all networking configurations (Mesh SSID/password, WiFi gateway credentials, MQTT info) and is invoked during deployment.
